...
test('Demo Login Test 1', async ({ page }) => {
    ...
    //await page.pause()
    await page.locator('[placeholder="Enter your username"]').fill('testuser')
    await page.locator('[placeholder="Enter your password"]').fill('testpassword')
...
test('Demo Login Test 2', async ({ page }) => {
    ...
    await page.getByRole('listitem').filter({ hasText: 'QA_Jane Tester456' }).locator('i').click();
